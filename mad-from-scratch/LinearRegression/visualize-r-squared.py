...
for i in range(3):
    ...
    axes[i].legend()
plt.tight_layout()
file = absolute_path + '/figures/comparison-raw-data.png'
os.makedirs(file, exist_ok=True), plt.savefig(file)
...
for i in range(3):
    ...
    axes[i].legend()
plt.tight_layout()
file = absolute_path + '/figures/comparison-ss.png'
os.makedirs(file, exist_ok=True), plt.savefig(file)
...
for i in range(3):
    ...
    axes[i].legend()
plt.tight_layout()
file = absolute_path + '/figures/comparison-yhat.png'
os.makedirs(file, exist_ok=True), plt.savefig(file)
...
for i in range(3):
    ...
    axes[i].legend()
plt.tight_layout()
file = absolute_path + '/figures/comparison-sse.png'
os.makedirs(file, exist_ok=True), plt.savefig(file)
...
for i in range(3):
    ...
    axes[i].legend()
plt.tight_layout()
file = absolute_path + '/figures/comparison-ssr.png'
os.makedirs(file, exist_ok=True), plt.savefig(file)
...
for i in range(3):
    ...
    axes[i].legend()
plt.tight_layout()
file = absolute_path + '/figures/comparison-rsquared.png'
os.makedirs(file, exist_ok=True), plt.savefig(file)
#
#
